...
def Main():
    ...
    # (TEST) Value to check the new colission check alghorithm
    APPLE_SIZE = 20 # It will be 10 in the next lesson
    ...
    while gameLoop == True:
        ...
        while gameOver == False:
            ...
            # If the snake position in x axis is beetween the apple position...
            if posSnake['x'] >= posApple['x'] and posSnake['x'] <= posApple['x'] + APPLE_SIZE:

                # And IF the snake position in y axis is beetween the apple position...
                if posSnake['y'] >= posApple['y'] and posSnake['y'] <= posApple['y'] + APPLE_SIZE:

                    # Snake will eat the apple. To do that...
            ...
            #  If the snake overpass the limits of screen # BOTTOM NOTE 3
            ...
            arrayApple = (posApple['x'] , posApple['y'], APPLE_SIZE, APPLE_SIZE) # Change this value 23 lesson
