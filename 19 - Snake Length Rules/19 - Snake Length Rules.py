...
#==============================================================================
# Draw a snake
def DrawSnake(surface, color, snakeCoord, snakeSize):
    ...
    for XnY in snakeCoord:
        ...
        pygame.draw.rect(surface, color, [XnY[X_AXIS], XnY[Y_AXIS], snakeSize,snakeSize])
...
def Main():
    ...
    SCREEN_LIMIT = {'x': SCREEN_WIDTH - GAME_BLOCK_SIZE, 'y': SCREEN_HEIGHT - GAME_BLOCK_SIZE }

    # Generate an random x and y axis positions
    randomX = random.randrange(0, SCREEN_LIMIT['x'], GAME_BLOCK_SIZE)
    randomY = random.randrange(0, SCREEN_LIMIT['y'], GAME_BLOCK_SIZE)
    ...
    while gameLoop == True:
        ...
        while gameOver == False:
            ...
            # Store the position of the snake    
            snakeCoord = []
            ...
            # Receive coordinates of the blocks (only snake head by now)
            ...
            DrawSnake(gameDisplay, GREEN, snakeCoord, GAME_BLOCK_SIZE)

            # Apple array to the draw function
            arrayApple = (posApple['x'] , posApple['y'], GAME_BLOCK_SIZE, GAME_BLOCK_SIZE)
